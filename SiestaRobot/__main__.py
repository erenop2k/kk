...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the bot by sharing \
    ...
    if query.data == "siesta_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="one", url="https://t.me/irueueue"),
                    ],
                    [
                        InlineKeyboardButton(text="two", url="https://t.me/irueueue"),
                        InlineKeyboardButton(text="op", url="https://t.me/irueueue"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(text=gs(chat.id, "help_button"), callback_data="help_back"),
                            InlineKeyboardButton(text=gs(chat.id, "darling_button"), url="t.me/TheDevil012"),
                            InlineKeyboardButton(text=gs(chat.id, "chat_grp_button"), url="t.me/TheDevil012"),
                        ],
                        [
                            InlineKeyboardButton(text=gs(chat.id, "add_bot_to_group_button"), url="t.me/Mikasa012_bot?startgroup=new"),
                        ]
